...
const Login = () =>{
    ...
    return (
        <div className ='w-screen h-screen relative'>
           {isForgotPassword &&  <div className = 'absolute top-0 left-0 bottom-0 right-0 flex flex-col items-center py-8 z-50 bg-white'> 
            ...
            <div className="flex items-center gap-2">
              ...
              />
                ...
                <div className ='flex w-full items-center justify-between my-2 text-sm'> 
                    {!isRegister &&  <span onClick = {() => setIsForgotPassword } className ='text-blue-500 hover:underline cursor-pointer'> Forgot your account</span>}
                    {!isRegister &&  <span 
